...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('main-screen/assets/img/favicons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('main-screen/assets/img/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('main-screen/assets/img/favicons/favicon-16x16.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('main-screen/assets/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ asset('main-screen/assets/img/favicons/manifest.json') }}">
      ...
      <section id="product">
        ...
        <div class="container">
          <div class="row mb-4">
            ...
            <div class="col-md-6">
              <div class="w-100 h-100 p-5 services-card-shadow rounded-4"><img src="{{ asset('main-screen/assets/img/icons/1.png') }}" alt="Dashboard" style="width:95px;" />
